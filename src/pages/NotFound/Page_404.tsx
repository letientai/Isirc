...
function Page_404() {
  ...
  return (
    <div className="bg-gray-800 w-full min-h-screen flex justify-center">
      <div className="w-full max-w-5xl mx-auto flex-col justify-start items-center lg:gap-16 gap-10 inline-flex lg:pt-[180px] pt-12 lg:pb-28 pb-12">
        <div className="border border-primary h-[550px] rounded-lg w-full">
          <div className="p-8 flex justify-between items-center border-b border-primary/70">
            <div className="block">
              <svg
                width="204"
                height="18"
          ...
          <div className="relative h-[calc(550px-85px)] flex justify-center items-center flex-col">
            ...
            >
              <path
                ...
                // fill="#ffeeee"
                className="fill-primary/40 stroke-primary/90"
                // stroke="#e54646"
              />
              <path
            ...
            <div className="block text-center mt-5">
              <h5 className="md:text-xl text-lg leading-8 text-white font-medium mb-1.5">
                <span className="text-primary font-semibold ">Oops!</span> It seems like you've
                taken a wrong turn
              </h5>
              <p className="text-sm text-white">We're working to bring it back.</p>
            </div>
          </div>
        </div>
      </div>
